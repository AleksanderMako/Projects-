...
CREATE TABLE `student_bill` (
  ...
  `subtotal` double(11,3) DEFAULT NULL,
  `balance` double(11,3) DEFAULT NULL,
  PRIMARY KEY (`student_id`),
  CONSTRAINT `student_bill_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`)
...
INSERT INTO `student_bill` VALUES (1000,0.000,400.000),(1001,300.000,0.000),(1002,0.000,250.000);
